...
for file in files[0:1]:
    ...
    batch_size = 1
    bev_h = 600 #height of the Unity generated bev i consider (if i crop then consider cropped size)
    bev_w = 600 #width of the Unity generated bev i consider (if i crop then consider  cropped size)
    ...
    height_anchors = [0.406 ,0.744 ,0.801 ]
    bev_mask = []
    ...
    for camtype in ['front','left','rear','right']:
        ...
        for height in height_anchors:
            ...
            for idx in valididxes:
                ...
                #print(bloc)
                if (camtype == 'front' and bloc[1] < 400) or  (camtype == 'left' and bloc[0] < 400) or (camtype == 'rear' and bloc[1] > 200) or (camtype == 'right' and bloc[0] > 200):
